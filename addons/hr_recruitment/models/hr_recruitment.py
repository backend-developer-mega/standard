...
class Applicant(models.Model):
    ...
    stage_id = fields.Many2one('hr.recruitment.stage', 'Estado', track_visibility='onchange',
    ...
    job_id = fields.Many2one('hr.job', "Departamento")
    ...
    attachment_ids = fields.One2many('ir.attachment', 'res_id', domain=[('res_model', '=', 'hr.applicant')], string='Archivo', track_visibility="always")
