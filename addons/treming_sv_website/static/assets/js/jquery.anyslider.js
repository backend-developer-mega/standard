...
;(function (root, factory) {
    ...
    var AnySlider = function (slider, options) {
        ...
        if (options.showControls && orgNumSlides > 1) {
            slider.prepend('<a href="#" class="as-prev-arrow" title="LABEL"> <span class="slider-left-arrow"></span> </a>'.replace(/LABEL/g, options.prevLabel));
            slider.append('<a href="#" class="as-next-arrow" title="LABEL"> <span class="slider-right-arrow"></span> </a>'.replace(/LABEL/g, options.nextLabel));
