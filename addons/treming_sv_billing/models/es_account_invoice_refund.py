...
class ESAccountInvoiceRefund(models.TransientModel):
    ...
    tipon = fields.Selection([("credito","Crédito"),("debito","Débito")],string="Tipo de Nota", help="Tipo de Nota Rectificativa",required=True)
    ...
    def compute_refund(self, mode='refund'):
        ...
        for form in self:
            ...
            for inv in inv_obj.browse(context.get('active_ids')):
                ...
                refund = inv.refund(form.date_invoice, date, description, inv.journal_id.id,tipon=form.tipon)
